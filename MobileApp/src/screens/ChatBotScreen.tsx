...
type IChatScreenProps = NativeStackScreenProps<RootStackParamList, 'ChatBot'>;

const ChatBotScreen: React.FC<IChatScreenProps> = ({navigation, route}) => {
