...
type Props = NativeStackScreenProps<RootStackParamList, 'UserIntroductionEdit'>;

const UserIntroductionEditScreen: React.FC<Props> = ({navigation}) => {
    ...
    const [wordCount, setWordCount] = useState<number>(
        info?.introduction ? info?.introduction.length : 0,
    );
    ...
    return (
        <View style={styles.container}>
            <MinorNavBar
                middleText={`Edit User Introduction`}
...
export default UserIntroductionEditScreen;
