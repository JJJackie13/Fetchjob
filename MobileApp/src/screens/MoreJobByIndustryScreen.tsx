...
type Props = NativeStackScreenProps<RootStackParamList, 'MoreJobByIndustry'>;

const MoreJobByIndustryScreen: React.FC<Props> = ({navigation}) => {
    ...
    async function fetchAllJob() {
        try {
            const res = await fetch(`${API_URL}/job/recommended/all/industry`, {
                headers: {
...
export default MoreJobByIndustryScreen
